#############################################################################
# Makefile for building: Pr_1
# Generated by qmake (3.1) (Qt 5.15.3)
# Project:  Pr_1.pro
# Template: app
# Command: /usr/lib/qt5/bin/qmake -o Makefile Pr_1.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug
#############################################################################
...
COMPRESS      = gzip -9f
DISTNAME      = Pr_11.0.0
DISTDIR = /home/juuxi/Desktop/prog/ETU/2nd_course/Pr_1/Pr_1/.tmp/Pr_11.0.0
LINK          = g++
LFLAGS        = 
...
Makefile: Pr_1.pro /usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++/qmake.conf /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/unix.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/linux.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/sanitize.conf \
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/common/gcc-base.conf \
		...
		/usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/lex.prf \
		Pr_1.pro
	$(QMAKE) -o Makefile Pr_1.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug
...
distdir: FORCE
	...
	$(COPY_FILE) --parents application.h array.h number.h $(DISTDIR)/
	$(COPY_FILE) --parents application.cpp array.cpp main.cpp $(DISTDIR)/
...
install_target: first FORCE
	@test -d $(INSTALL_ROOT)/opt/Pr_1/bin || mkdir -p $(INSTALL_ROOT)/opt/Pr_1/bin
	$(QINSTALL_PROGRAM) $(QMAKE_TARGET) $(INSTALL_ROOT)/opt/Pr_1/bin/$(QMAKE_TARGET)

uninstall_target: FORCE
	-$(DEL_FILE) $(INSTALL_ROOT)/opt/Pr_1/bin/$(QMAKE_TARGET)
	-$(DEL_DIR) $(INSTALL_ROOT)/opt/Pr_1/bin/ 
